...
def spec_redshift(flux, wavelength, filt, line, z, percentile, filename):
...
for i in files:
    ...
    if 'cem.fits' in i:
        ...
        #print('-----------------------')
        #print()
        spec_redshift(spectra, wavelength, filt, line_wavelength, z1, 99, i)
    ...
    if 'mods1b' in i:
        ...
        #table, He_line_names, He_lines, He_line_flux = analysis(spectra, wavelength, filt, line_wavelength, 
